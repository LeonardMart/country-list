...
const AssociatedCountry = () => {
  ...
  const filteredCountries = countries.filter((item)=>
    item.name.common.toLowerCase().includes(searchKeyword.toLocaleLowerCase()))
  ...
  return (
    <div className="w-full h-full p-4 rounded-md">
      ...
      <div className="flex flex-col space-y-4">
        ...
        <div className="flex flex-col space-y-4 bg-gray-300 w-full h-full p-4 rounded-md">
              ...
              <div
                ...
                <div className="flex flex-row items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-gray-600 h-full hover:scale-110 md:hidden lg:hidden w-6">
                    <ArrowRight
                      width={20}
                      height={20}
                    />
